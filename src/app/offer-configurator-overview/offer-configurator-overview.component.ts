...
@Component({
  selector: 'app-offer-configurator-overview',
  templateUrl: './offer-configurator-overview.component.html',
  styleUrls: ['./offer-configurator-overview.component.css'],
})
export class OfferConfiguratorOverviewComponent implements OnInit {
